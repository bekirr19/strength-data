        ...
        {done ? (
          ...
          <div style={{ display:'flex',flexDirection:'column',gap:16 }}>
            ...
            <div>
              ...
              <textarea value={msg} onChange={e => setMsg(e.target.value)} placeholder={cat==='bug' ? 'Describe the bug and steps to reproduce…' : cat==='idea' ? 'What would you like to see?' : 'Your message…'} rows={5}
            ...
            <Button variant="primary" fullWidth size="lg" icon={<LIcon name="Send" size={18} />}
              onClick={() => { if (!msg.trim()) { push({tone:'error',title:'Empty message',message:'Write something before sending.'}); return; } setDone(true); push({tone:'success',title:'Sent!',message:'Thanks for your feedback.'}); }}>
              Send feedback
            </Button>
